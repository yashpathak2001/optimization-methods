export const CODE_TEMPLATES = 
  {
    cpp: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "#include <algorithm>" },
        { key: "kruskal_init", text: "vector<int> parent(n), rank(n, 0);" },
        { key: "kruskal_init", text: "for (int i = 0; i < n; ++i) parent[i] = i;" },
        { key: "kruskal_init", text: "sort(edges.begin(), edges.end(), [](auto &a, auto &b) { return a.w < b.w; });" },
        { key: "kruskal_add", text: "for (auto &e : edges) {" },
        { key: "kruskal_add", text: "  int u = find(e.u), v = find(e.v);" },
        { key: "kruskal_add", text: "  if (u != v) {" },
        { key: "kruskal_add", text: "      mst.push_back(e); union(u, v);" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip (would create cycle)" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "// MST constructed" },
      ],
      bfs: [
    ...
    c: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "#include <stdlib.h>" },
        { key: "kruskal_init", text: "int parent[n], rank[n] = {0};" },
        { key: "kruskal_init", text: "for (int i = 0; i < n; i++) parent[i] = i;" },
        { key: "kruskal_init", text: "qsort(edges, m, sizeof(Edge), compare_edges);" },
        { key: "kruskal_add", text: "for (int i = 0; i < m; i++) {" },
        { key: "kruskal_add", text: "  int u = find(edges[i].u), v = find(edges[i].v);" },
        { key: "kruskal_add", text: "  if (u != v) {" },
        { key: "kruskal_add", text: "      mst[mst_size++] = edges[i]; union(u, v);" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "// MST constructed" },
      ],
      bfs: [
    ...
    java: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "import java.util.*;" },
        { key: "kruskal_init", text: "int[] parent = new int[n], rank = new int[n];" },
        { key: "kruskal_init", text: "for (int i = 0; i < n; i++) parent[i] = i;" },
        { key: "kruskal_init", text: "Arrays.sort(edges, (a, b) -> Double.compare(a.w, b.w));" },
        { key: "kruskal_add", text: "for (Edge e : edges) {" },
        { key: "kruskal_add", text: "  int u = find(e.u), v = find(e.v);" },
        { key: "kruskal_add", text: "  if (u != v) {" },
        { key: "kruskal_add", text: "      mst.add(e); union(u, v);" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "// MST constructed" },
    ...
    python: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "parent = list(range(n)); rank = [0] * n" },
        { key: "kruskal_init", text: "edges.sort(key=lambda e: e.w)" },
        { key: "kruskal_init", text: "mst = []" },
        { key: "kruskal_add", text: "for u, v, w in edges:" },
        { key: "kruskal_add", text: "  root_u, root_v = find(u), find(v)" },
        { key: "kruskal_add", text: "  if root_u != root_v:" },
        { key: "kruskal_add", text: "      mst.append((u, v, w)); union(root_u, root_v)" },
        { key: "kruskal_skip", text: "  # else: same component, skip" },
        { key: "kruskal_done", text: "# MST constructed" },
      ],
      bfs: [
    ...
    rust: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "let mut parent: Vec<usize> = (0..n).collect();" },
        { key: "kruskal_init", text: "let mut rank = vec![0; n];" },
        { key: "kruskal_init", text: "edges.sort_by(|a, b| a.w.partial_cmp(&b.w).unwrap());" },
        { key: "kruskal_add", text: "for e in edges {" },
        { key: "kruskal_add", text: "  let u = find(e.u, &mut parent);" },
        { key: "kruskal_add", text: "  let v = find(e.v, &mut parent);" },
        { key: "kruskal_add", text: "  if u != v {" },
        { key: "kruskal_add", text: "      mst.push(e); union(u, v, &mut parent, &mut rank);" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "// MST constructed" },
    ...
    typescript: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "const parent: number[] = Array.from({length: n}, (_, i) => i);" },
        { key: "kruskal_init", text: "const rank: number[] = Array(n).fill(0);" },
        { key: "kruskal_init", text: "edges.sort((a, b) => a.w - b.w);" },
        { key: "kruskal_add", text: "for (const e of edges) {" },
        { key: "kruskal_add", text: "  const u = find(e.u), v = find(e.v);" },
        { key: "kruskal_add", text: "  if (u !== v) {" },
        { key: "kruskal_add", text: "      mst.push(e); union(u, v);" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "// MST constructed" },
    ...
    go: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "parent := make([]int, n); rank := make([]int, n)" },
        { key: "kruskal_init", text: "for i := range parent { parent[i] = i }" },
        { key: "kruskal_init", text: "sort.Slice(edges, func(i, j int) bool { return edges[i].w < edges[j].w })" },
        { key: "kruskal_add", text: "for _, e := range edges {" },
        { key: "kruskal_add", text: "  u, v := find(e.u), find(e.v)" },
        { key: "kruskal_add", text: "  if u != v {" },
        { key: "kruskal_add", text: "      mst = append(mst, e); union(u, v)" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "// MST constructed" },
    ...
    kotlin: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "val parent = IntArray(n) { it }" },
        { key: "kruskal_init", text: "val rank = IntArray(n)" },
        { key: "kruskal_init", text: "edges.sortBy { it.w }" },
        { key: "kruskal_add", text: "for (e in edges) {" },
        { key: "kruskal_add", text: "  val u = find(e.u); val v = find(e.v)" },
        { key: "kruskal_add", text: "  if (u != v) {" },
        { key: "kruskal_add", text: "      mst.add(e); union(u, v)" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip" },
    ...
    swift: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "var parent = Array(0..<n)" },
        { key: "kruskal_init", text: "var rank = Array(repeating: 0, count: n)" },
        { key: "kruskal_init", text: "edges.sort { $0.w < $1.w }" },
        { key: "kruskal_add", text: "for e in edges {" },
        { key: "kruskal_add", text: "  let u = find(e.u), v = find(e.v)" },
        { key: "kruskal_add", text: "  if u != v {" },
        { key: "kruskal_add", text: "      mst.append(e); union(u, v)" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "// MST constructed" },
    ...
    csharp: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "int[] parent = new int[n], rank = new int[n];" },
        { key: "kruskal_init", text: "for (int i = 0; i < n; i++) parent[i] = i;" },
        { key: "kruskal_init", text: "Array.Sort(edges, (a, b) => a.w.CompareTo(b.w));" },
        { key: "kruskal_add", text: "foreach (var e in edges) {" },
        { key: "kruskal_add", text: "  int u = Find(e.u), v = Find(e.v);" },
        { key: "kruskal_add", text: "  if (u != v) {" },
        { key: "kruskal_add", text: "      mst.Add(e); Union(u, v);" },
        { key: "kruskal_add", text: "  }" },
    ...
    ruby: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "parent = (0...n).to_a; rank = Array.new(n, 0)" },
        { key: "kruskal_init", text: "edges.sort_by! { |e| e[:w] }" },
        { key: "kruskal_add", text: "edges.each do |e|" },
        { key: "kruskal_add", text: "  u, v = find(e[:u]), find(e[:v])" },
        { key: "kruskal_add", text: "  if u != v" },
        { key: "kruskal_add", text: "      mst << e; union(u, v)" },
        { key: "kruskal_add", text: "  end" },
        { key: "kruskal_skip", text: "  # else: same component, skip" },
        { key: "kruskal_add", text: "end" },
        { key: "kruskal_done", text: "# MST constructed" },
      ],
    ...
    php: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "$parent = range(0, $n - 1); $rank = array_fill(0, $n, 0);" },
        { key: "kruskal_init", text: "usort($edges, fn($a, $b) => $a['w'] <=> $b['w']);" },
        { key: "kruskal_add", text: "foreach ($edges as $e) {" },
        { key: "kruskal_add", text: "  $u = find($e['u']); $v = find($e['v']);" },
        { key: "kruskal_add", text: "  if ($u != $v) {" },
        { key: "kruskal_add", text: "      $mst[] = $e; union($u, $v);" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  // else: same component, skip" },
    ...
    scala: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "val parent = Array.tabulate(n)(identity)" },
        { key: "kruskal_init", text: "val rank = Array.fill(n)(0)" },
        { key: "kruskal_init", text: "val sortedEdges = edges.sortBy(_.w)" },
        { key: "kruskal_add", text: "for (e <- sortedEdges) {" },
        { key: "kruskal_add", text: "  val u = find(e.u); val v = find(e.v)" },
        { key: "kruskal_add", text: "  if (u != v) {" },
        { key: "kruskal_add", text: "      mst :+= e; union(u, v)" },
        { key: "kruskal_add", text: "  }" },
    ...
    haskell: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "let parent = [0..n-1]" },
        { key: "kruskal_init", text: "let rank = replicate n 0" },
        { key: "kruskal_init", text: "let sortedEdges = sortBy (compare `on` weight) edges" },
        { key: "kruskal_add", text: "mst = foldl kruskalStep [] sortedEdges" },
        { key: "kruskal_add", text: "where kruskalStep acc e" },
        { key: "kruskal_add", text: "  | find (u e) == find (v e) = acc" },
        { key: "kruskal_add", text: "  | otherwise = e : acc" },
        { key: "kruskal_done", text: "-- MST constructed" },
      ],
      bfs: [
    ...
    ocaml: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "let parent = Array.init n (fun i -> i) in" },
        { key: "kruskal_init", text: "let rank = Array.make n 0 in" },
        { key: "kruskal_init", text: "let sorted_edges = List.sort (fun a b -> compare a.w b.w) edges in" },
        { key: "kruskal_add", text: "List.fold_left (fun mst e ->" },
        { key: "kruskal_add", text: "  let u = find e.u and v = find e.v in" },
        { key: "kruskal_add", text: "  if u <> v then (union u v; e :: mst) else mst" },
        { key: "kruskal_add", text: ") [] sorted_edges" },
        { key: "kruskal_done", text: "(* MST constructed *)" },
      ],
      bfs: [
    ...
    dart: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "List<int> parent = List.generate(n, (i) => i);" },
        { key: "kruskal_init", text: "List<int> rank = List.filled(n, 0);" },
        { key: "kruskal_init", text: "edges.sort((a, b) => a.w.compareTo(b.w));" },
        { key: "kruskal_add", text: "for (var e in edges) {" },
        { key: "kruskal_add", text: "  int u = find(e.u), v = find(e.v);" },
        { key: "kruskal_add", text: "  if (u != v) {" },
        { key: "kruskal_add", text: "      mst.add(e); union(u, v);" },
        { key: "kruskal_add", text: "  }" },
    ...
    lua: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "local parent = {}; local rank = {}" },
        { key: "kruskal_init", text: "for i = 1, n do parent[i] = i; rank[i] = 0 end" },
        { key: "kruskal_init", text: "table.sort(edges, function(a, b) return a.w < b.w end)" },
        { key: "kruskal_add", text: "for _, e in ipairs(edges) do" },
        { key: "kruskal_add", text: "  local u, v = find(e.u), find(e.v)" },
        { key: "kruskal_add", text: "  if u ~= v then" },
        { key: "kruskal_add", text: "      table.insert(mst, e); union(u, v)" },
        { key: "kruskal_add", text: "  end" },
        { key: "kruskal_skip", text: "  -- else: same component, skip" },
        { key: "kruskal_add", text: "end" },
        { key: "kruskal_done", text: "-- MST constructed" },
    ...
    perl: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "my @parent = (0..$n-1); my @rank = (0) x $n;" },
        { key: "kruskal_init", text: "@edges = sort { $a->{w} <=> $b->{w} } @edges;" },
        { key: "kruskal_add", text: "for my $e (@edges) {" },
        { key: "kruskal_add", text: "  my ($u, $v) = (find($e->{u}), find($e->{v}));" },
        { key: "kruskal_add", text: "  if ($u != $v) {" },
        { key: "kruskal_add", text: "      push @mst, $e; union($u, $v);" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  # else: same component, skip" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "# MST constructed" },
    ...
    r: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "parent <- 0:(n-1); rank <- rep(0, n)" },
        { key: "kruskal_init", text: "edges <- edges[order(edges$w), ]" },
        { key: "kruskal_add", text: "for (i in 1:nrow(edges)) {" },
        { key: "kruskal_add", text: "  u <- find(edges[i, ]$u); v <- find(edges[i, ]$v)" },
        { key: "kruskal_add", text: "  if (u != v) {" },
        { key: "kruskal_add", text: "      mst <- rbind(mst, edges[i, ]); union(u, v)" },
        { key: "kruskal_add", text: "  }" },
        { key: "kruskal_skip", text: "  # else: same component, skip" },
        { key: "kruskal_add", text: "}" },
        { key: "kruskal_done", text: "# MST constructed" },
    ...
    matlab: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "parent = 0:n-1; rank = zeros(1, n);" },
        { key: "kruskal_init", text: "[~, idx] = sort([edges.w]); edges = edges(idx);" },
        { key: "kruskal_add", text: "for i = 1:length(edges)" },
        { key: "kruskal_add", text: "  u = find(edges(i).u); v = find(edges(i).v);" },
        { key: "kruskal_add", text: "  if u ~= v" },
        { key: "kruskal_add", text: "      mst = [mst; edges(i)]; union(u, v);" },
        { key: "kruskal_add", text: "  end" },
        { key: "kruskal_skip", text: "  % else: same component, skip" },
        { key: "kruskal_add", text: "end" },
        { key: "kruskal_done", text: "% MST constructed" },
    ...
    julia: {
      ...
      kruskal: [
        { key: "kruskal_init", text: "parent = collect(0:n-1); rank = zeros(Int, n)" },
        { key: "kruskal_init", text: "sort!(edges, by = e -> e.w)" },
        { key: "kruskal_add", text: "for e in edges" },
        { key: "kruskal_add", text: "  u, v = find(e.u), find(e.v)" },
        { key: "kruskal_add", text: "  if u != v" },
        { key: "kruskal_add", text: "      push!(mst, e); union(u, v)" },
